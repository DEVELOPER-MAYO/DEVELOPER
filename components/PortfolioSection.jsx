...
<section>
    ...
    > 
    <h2 className="mb-1 selft-end font-serif text-2xl text-zinc-50 sm:text-3xl lg:text-4xl">
        {title}
    </h2>
    <div className="flex w-32 h-32 bg-zinc-900 items-center justify-center">
